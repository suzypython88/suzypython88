...
Welcome to my data portfolio! Here, I document a summary of the projects and courses I've undertaken in the data analysis field. 
...
| Project Link | Completion Date | Project Type | Skills | Project Description | Libraries |
|---|---|---|---|---|---|
| 🩸 [Diabetes Blood Glucose Analysis](xxxx) | Ongoing | Project | Data Cleaning, Data Wrangling, Exploratory Data Analysis and Data Visualisation | Exploratory data analysis of the daily blood glucose levels of a type 1 diabetic (my boyfriend) using a Libre 2 arm sensor and log of associated activities to assess trigger points and solutions for better health outcomes | Pandas, Matplotlib, Seaborn |
